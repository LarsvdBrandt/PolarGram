                        ...
                        <div className="col-md-8 col-sm-6 border"
                            ...
                            <div className="row" style={{ padding: "1rem" }}>
                                                ...
                                                <p >
                                                    {isAuthenticated && comment.userId === userId && (
                                                        <button
                                                            ...
                                                            className="btn-sm btn-danger">X</button>
                                    ...
                                    {isAuthenticated && (
                                        <div className="row">
                                            <div className="col-lg-9">
                                                <div style={{ position: "sticky", bottom: "10px", marginBottom: "10px", backgroundColor: "black", background: "" }}>
                                                    <input onChange={handleChange} name="comment" className="form-control" placeholder="Comment something..."
                                                        data-testid="comment-input-string" type="comment" required />
                                                </div>
                                            </div>
                                            <div className="col-lg-3">
                                                <button data-testid="comment-input-submit" className="btn btn-primary" onClick={handleSubmit}>Send</button>
                                            </div>
                                        </div>
                                    )}
                                </div>
                                <button
                                    ...
                                    onClick={() => deleteComment({ id: "62a08fa364630a3a2563a092" })}
                                    data-testid="comment-delete-input" className="btn-sm btn-danger" hidden>X</button>
